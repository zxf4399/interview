...
6. [请分别用深度优先思想和广度优先思想实现一个拷贝函数？](https://github.com/zxf4399/fe-interview/issues/57)
7. [ES5/ES6 的继承除了写法以外还有什么区别？](https://github.com/zxf4399/fe-interview/issues/58)
8. [setTimeout、Promise、Async/Await 的区别](https://github.com/zxf4399/fe-interview/issues/61)
